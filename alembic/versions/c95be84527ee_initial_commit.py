...
Revision ID: c95be84527ee
Revises: 
Create Date: 2024-08-01 18:04:31.200438
...
def upgrade() -> None:
    ...
    sa.Column('edited_date', sa.String(length=50), nullable=True),
    ...
    sa.Column('login_password', sa.String(length=100), nullable=True),
    ...
    sa.Column('product_image_name', sa.String(length=150), nullable=False),
    sa.Column('product_image_path', sa.String(length=150), nullable=False),
    sa.Column('created_date', sa.String(length=50), nullable=True),
    sa.Column('created_by', sa.String(length=100), nullable=False),
    sa.Column('edited_date', sa.String(length=50), nullable=True),
    sa.Column('edited_by', sa.String(length=100), nullable=True),
